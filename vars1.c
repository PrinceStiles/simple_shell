...
/**
 * replace_alias - this replaces an alias in tokenized string
 * @info: param struct
...
/**
 * replace_vars - this replaces vars in tokenizd string
 * @info: param struct
 * Return: 1 if replaced, else 0
 */
...
/**
 * is_chain - this tests if the current char in buffer is a chain delim
 * @info: param struct
 * @buf: char buffer
 * @p: address of current in buf
 * Return: 1 if chain delim, else 0
 */
